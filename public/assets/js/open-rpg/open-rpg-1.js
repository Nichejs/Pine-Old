...
define(["jquery", "socket"], function($, io){
	...
	OpenRPG.start = function(){
		$(OpenRPG.container).html('<div id="overlay" class="clickThrough"></div><canvas id="game" width="900" height="500"></canvas><div id="chatOut" class="clickThrough"></div><input type="text" id="chatIn" class="clickThrough" placeholder="Chat..."><div id="bottomInfo"></div>');
